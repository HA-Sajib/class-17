						...
						<fieldset class="content-group mt-10">
							...
							?>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control" name="details" id="details" placeholder="Default textarea"></textarea>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="text-right">
									...
									<button type="submit" name="saveBanner" class="btn btn-primary">Submit</button>
								</div>
							</form>
